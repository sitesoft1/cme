...
register_sidebar(array( // регистрируем левую колонку, этот кусок можно повторять для добавления новых областей для виджитов
	'name' => 'Попап форма', // Название в админке
	'id' => "sidebar-popupform", // идентификатор для вызова в шаблонах
	'description' => 'Вывод формы обратной связи', // Описалово в админке
...
register_sidebar(array( // регистрируем левую колонку, этот кусок можно повторять для добавления новых областей для виджитов
	'name' => 'Home map and addres', // Название в админке
	'id' => "sidebar-homemap", // идентификатор для вызова в шаблонах
	'description' => 'Адрес и карта в футере на главной', // Описалово в админке
	'before_widget' => '', // разметка до вывода каждого виджета
	'after_widget' => "", // разметка после вывода каждого виджета
	'before_title' => '', //  разметка до вывода заголовка виджета
	'after_title' => "", //  разметка после вывода заголовка виджета
...
register_sidebar(array( // регистрируем левую колонку, этот кусок можно повторять для добавления новых областей для виджитов
	'name' => 'Телефон в мобильной версии', // Название в админке
	'id' => "sidebar-homeright", // идентификатор для вызова в шаблонах
	'description' => 'Номер телефона и ссылка в меню на мобильной версии', // Описалово в админке
	'before_widget' => '', // разметка до вывода каждого виджета
	'after_widget' => "", // разметка после вывода каждого виджета
	'before_title' => '', //  разметка до вывода заголовка виджета
	'after_title' => "", //  разметка после вывода заголовка виджета
