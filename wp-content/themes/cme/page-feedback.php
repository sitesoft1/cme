 ...
 * Шаблон обычной страницы (page-feedback.php)
 * @package WordPress
            ...
            <div class="feedback__container container">
                <div class="feedback__cards">
                    ...
                    <?php foreach( $posts as $post ){
                            $feedback_user_name = get_field('feedback_user_name', $post->ID);
                            $car_brand = get_field('car_brand', $post->ID);
                            $feedback_images = get_field('feedback_images', $post->ID);
                            $feedback_date = get_field('feedback_date', $post->ID);
                    ?>
                        <div class="feedback__card card-feedback">
                            <div class="card-feedback__heading">
                                <h2 class="card-feedback__title title-h2"><?php echo $post->post_title; ?></h2>
                                <div class="card-feedback__date"><?php echo $feedback_date; ?></div>
                                <div class="card-feedback__person">
                                    <div class="card-feedback__name"><?php echo $feedback_user_name; ?></div>
                                    <div class="card-feedback__car">(<?php echo $car_brand; ?>)</div>
                                </div>
                            </div>
                            <div class="card-feedback__body">
                                <div class="card-feedback__wrapper">
                                    <div class="card-feedback__content">
                                        <?php
                                        $content_arr = explode('.', $post->post_content);
                                        $content_show = implode('.',array_slice($content_arr, 0, 5));
                                        $content_hide = implode('.',array_slice($content_arr, 5, count($content_arr)));
                                        ?>
                                        
                                        <?php echo $content_show; ?>
    
                                        <?php if(!empty($content_hide) or !empty($feedback_images)){ ?>
                                            <div class="card-feedback__hidden">
                                                <p><?php echo $content_hide; ?></p>
                                                <div class="card-feedback__gallery scroll-table">
        
                                                <?php if(!empty($feedback_images)){ ?>
                                                    <?php foreach ($feedback_images as $feedback_image){ ?>
                                                        <div class="card-feedback__item">
                                                            <div class="card-feedback__img">
                                                                <a data-fancybox="feedback" href="<?php echo $feedback_image; ?>"><picture><source srcset="<?php echo $feedback_image; ?>" type="image/webp"><img src="<?php echo $feedback_image; ?>"></picture></a>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                <?php } ?>
                                    ...
                                    <?php if(!empty($content_hide) or !empty($feedback_images)){ ?>
                                    <a href="" class="card-feedback__btn">
                                        <span class="card-feedback__btn-icon"></span>
                                        <span class="card-feedback__btn-text">Читать весь отзыв</span>
                                    </a>
                                    <?php } ?>
                                </div>
                ...
                <div class="pagination">
                    <ul class="pagination__list">
                        ...
                        <li><a href="" class="pagination__page">2</a></li>
                        <li><a href="" class="pagination__page">3</a></li>
                        <li><span class="pagination__page pagination__page--dots">...</span></li>
