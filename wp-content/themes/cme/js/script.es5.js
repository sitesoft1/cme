...
$(document).ready(function () {
  ...
  */
  ...
  if (mediaQuerySmMax.matches) {
    ...
    var slidesNumber = $('.news__card').length;
    var slidesClonedNumber = $('.news__card.slick-cloned').length;
  ...
  function handleTabletChange(e) {
    if (e.matches) {
      ...
      var _itemHeight = $('.filter__item').innerHeight();

      items.css({
        "max-height": _itemHeight * 2
      });
      $(window).resize(function () {
        var itemHeight = $('.filter__item').innerHeight();
        items.css({
  ...
  if (mediaQuerySmMax.matches) {
    ...
    var _itemHeight2 = $('.filter__item').innerHeight();

    items.css({
      "max-height": _itemHeight2 * 2
    });
    showBtn.click(function (e) {
      e.preventDefault();
      $(this).toggleClass('_active');
  ...
  var slider = document.querySelector('.scroll-table');
  var isDown = false;
  var startX;
  var scrollLeft;
